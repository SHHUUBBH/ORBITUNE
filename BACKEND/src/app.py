...
app.add_middleware(
    ...
    allow_origin_regex=r"http://(localhost|127\.0\.0\.1):(3000|5173)|https://.*\.vercel\.app|https://.*\.onrender\.app",
...
# Static mount for thumbnails only (spatial audio served from Supabase)
