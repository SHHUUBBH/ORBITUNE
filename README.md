...
![Hugging Face](https://img.shields.io/badge/%F0%9F%A4%97%20Hugging%20Face-Spaces-blue?style=flat-square)
...
Orbitune utilizes a decoupled, serverless-inspired architecture to handle heavy ML workloads:
- **Frontend Engine**: Hosted on Vercel for fast, global content delivery.
- **Backend Processing**: Dockerized FastAPI server running on Hugging Face Spaces to provide the high RAM required for Demucs audio separation.
- **Persistent Data**: Supabase PostgreSQL for library metadata and Supabase Storage Buckets for public MP3 streaming.
